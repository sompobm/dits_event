<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Company.aspx.cs" Inherits="Dynamic_Events.Modules.Master.Company" %>
        ...
        <ext:Viewport ID="Viewport1" runat="server" Layout="BorderLayout">
            <Items>
                <ext:GridPanel ID="grdDetail" runat="server" Title="List" Margins="5 0 5 5"
                    ...
                    <Store>
                        <ext:Store ID="storeDetail" runat="server" PageSize="20" RemotePaging="true" RemoteSort="true">
                            <Proxy>
                                <ext:AjaxProxy Url="http://localhost/DynamicEventsAPI/api/Company/Get">
                                    <Reader>
                ...
                <ext:FormPanel Icon="Group" runat="server" ID="FormDetail" Title="Details" Region="East"
                    ...
                    <Items>
                        <ext:TextField ID="txtCompanyNo" runat="server" FieldLabel="Company No" Name="CompanyNo" Width="200" AllowBlank="false" />
                        <ext:TextField ID="txtCompanyName" runat="server" FieldLabel="Company Name" Name="CompanyName" AllowBlank="false" />
